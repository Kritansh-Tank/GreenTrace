...
import { Leaf, Mail, Lock, Eye, EyeOff, User, AlertCircle, CheckCircle, ArrowRight } from 'lucide-react'
  ...
  return (
    <div className="h-screen bg-gray-50 flex overflow-hidden">
      ...
      <div className="hidden lg:flex flex-1 relative">
        <img src="https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?w=1200&q=80"
          alt="Green landscape" className="w-full h-full object-cover" />
        <div className="absolute inset-0 bg-green-900/50 flex flex-col items-start justify-end p-14">
          <blockquote className="text-white text-2xl font-bold leading-snug mb-3">
            "The best time to plant<br />a tree was 20 years ago.<br />The second best time is now."
          </blockquote>
          <p className="text-green-200 text-sm">— Chinese Proverb</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-gray-500 mb-5">Start your journey to net zero</p>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input id="register-name" type="text" value={name} onChange={e => setName(e.target.value)} required placeholder="Jane Smith"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input id="register-password" type={showPassword ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)} required placeholder="Min. 6 characters"
            ...
            <button type="submit" id="register-submit" disabled={loading} className="btn-pill w-full justify-center !pl-6">
              {loading
                ? <span className="w-4 h-4 border-2 border-white/40 border-t-white rounded-full animate-spin" />
                : <>Create Account <span className="arrow-circle !w-8 !h-8"><ArrowRight className="w-3.5 h-3.5" /></span></>}
            </button>
          </form>
